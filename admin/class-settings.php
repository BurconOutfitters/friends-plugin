...
class Settings {
	...
	public function __construct() {
		...
		add_filter( FRIENDS_PARENT_PREFIX . '_tabs_site_settings', [ $this, 'site_settings_tab' ], 11 );

		// Do the settings section for the new tab.
		add_filter( FRIENDS_PARENT_PREFIX . '_section_site_settings', [ $this, 'site_settings_section' ], 11 );

		// Do the settings fields for the new tab.
		add_filter( FRIENDS_PARENT_PREFIX . '_fields_site_settings', [ $this, 'site_settings_fields' ], 11 );

		// Addon tab save button text.
		add_filter( FRIENDS_PARENT_PREFIX . '_save_site_settings', [ $this, 'site_settings_save' ], 11 );
	...
	public function site_settings_tab( $tabs ) {
		...
		$extended_tab = [
			sprintf(
				...
				esc_html__( 'Extended', 'friends-plugin' )
			)
		];
	...
	public function site_settings_save( $save ) {
		...
		if ( 'extended' == $active_tab ) {
			$save = __( 'Save Extended', 'friends-plugin' );
			return $save;
		}
