...
class Admin {
	...
	public function __construct() {
		...
		$menu_settings = get_option( 'friends_hide_addon_settings' );
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 'friends-plugin', plugin_dir_url( __FILE__ ) . 'assets/css/admin.css', [], FRIENDS_VERSION, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'friends-plugin', plugin_dir_url( __FILE__ ) . 'assets/js/admin.js', [ 'jquery' ], FRIENDS_VERSION, true );
