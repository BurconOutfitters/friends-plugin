...
class Frontend {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 'friends-plugin', plugin_dir_url( __FILE__ ) . 'assets/css/frontend.css', [], FRIENDS_VERSION, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'friends-plugin', plugin_dir_url( __FILE__ ) . 'assets/js/frontend.js', [ 'jquery' ], FRIENDS_VERSION, true );
